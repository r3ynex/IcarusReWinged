...
public class FixedDiscordsWingsModel<T extends LivingEntity> extends FixedWingEntityModel<T> {
	...
	public FixedDiscordsWingsModel(ModelPart root) {
		super(root);
	...
	public static LayerDefinition getLayerDefinition() {
		MeshDefinition modelData = FixedWingEntityModel.getModelData();
		...
		modelPartData4.addOrReplaceChild("leftWing05", CubeListBuilder.create().texOffs(32, 31)
				.addBox(0.4F, -4.0F, -12.3F, 0.001F, 20.0F, 13.0F, true),
