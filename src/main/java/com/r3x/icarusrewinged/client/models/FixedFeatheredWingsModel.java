...
public class FixedFeatheredWingsModel<T extends LivingEntity> extends FixedWingEntityModel<T> {
	...
	public FixedFeatheredWingsModel(ModelPart root) {
		super(root);
	...
	public static LayerDefinition getLayerDefinition() {
		...
		modelPartData4.addOrReplaceChild("leftWing05", CubeListBuilder.create()
						.texOffs(0, 13)
						.mirror()
						.addBox(0.4F, -4.0F, -12.3F, 0.001F, 20.0F, 13.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition modelPartData10 = modelPartData9.addOrReplaceChild("rightWing04", CubeListBuilder.create().texOffs(33, 25)
				...
				PartPose.offsetAndRotation(0.0F, 0.5F, 7.2F, 1.0908F, 0.0F, 0.0F));
		modelPartData10.addOrReplaceChild("rightWing05", CubeListBuilder.create()
						.texOffs(0, 13)
						.addBox(-0.4F, -4.0F, -12.3F, 0.001F, 20.0F, 13.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, 4.8F, -0.2F));
